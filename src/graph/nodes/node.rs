use crate::{
    graph::{
        nodes::node_ext::{InputPortKinds, InputPorts, OutputPortKinds},
...
impl NodeExt for Node {
    ...
    fn all_input_ports(&self) -> InputPorts {
        match self {
            ...
            Self::Neq(neq) => neq.all_input_ports(),
    ...
    fn all_input_port_kinds(&self) -> InputPortKinds {
        match self {
            ...
            Self::Neq(neq) => neq.all_input_port_kinds(),
    ...
    fn update_input(&mut self, from: InputPort, to: InputPort) {
        match self {
            ...
            Self::Neq(neq) => neq.update_input(from, to),
    ...
    fn all_output_ports(&self) -> TinyVec<[OutputPort; 4]> {
        match self {
            ...
            Self::Neq(neq) => neq.all_output_ports(),
    ...
    fn all_output_port_kinds(&self) -> OutputPortKinds {
        match self {
            ...
            Self::Neq(neq) => neq.all_output_port_kinds(),
    ...
    fn update_output(&mut self, from: OutputPort, to: OutputPort) {
        match self {
            ...
            Self::Neq(neq) => neq.update_output(from, to),
